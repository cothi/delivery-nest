...
*/
-- DropForeignKey
ALTER TABLE `menu_category` DROP FOREIGN KEY `menu_category_restaurantId_fkey`;

-- DropForeignKey
ALTER TABLE `menu_item` DROP FOREIGN KEY `menu_item_menuCategoryId_fkey`;

-- DropForeignKey
ALTER TABLE `menu_item` DROP FOREIGN KEY `menu_item_restaurantId_fkey`;
